...
<?php $__env->startSection('container'); ?>
    ...
    <div class="col-lg-8">
        <form method="post" action="<?php echo e(route('admin.categories.index')); ?>" class="mb-5" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" id="name" name="name"
                    required value="<?php echo e(old('name')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="product_id">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jesse\Herd\InspiraUMKM\resources\views/dashboard/categories/create.blade.php ENDPATH**/ ?>