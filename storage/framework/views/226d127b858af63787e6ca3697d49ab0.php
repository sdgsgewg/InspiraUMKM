<div class="card order-card col-12 rounded p-3 mb-4 d-flex flex-column"
    ...
    <div class="col-12 mb-2 d-flex justify-content-between">
        <h6 class="fw-bold">
            <?php echo app('translator')->get('order.From'); ?> <?php echo e($transaction->buyer->name); ?>
    ...
    <div class="col-12 mt-2 d-flex flex-row justify-content-end gap-3">
        ...
        <?php if(in_array($transaction->transaction_status, ['Not Paid', 'Returned', 'Completed', 'Cancelled'])): ?>
...
<?php /**PATH C:\Users\jesse\Herd\InspiraUMKM\resources\views/components/transaction/orderReqCard.blade.php ENDPATH**/ ?>