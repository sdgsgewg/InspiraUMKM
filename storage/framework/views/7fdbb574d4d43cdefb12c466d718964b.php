...
<?php $__env->startSection('container'); ?>
    ...
    <div class="col-lg-8">
        <form method="post" action="<?php echo e(route('admin.options.index')); ?>" class="mb-5">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jesse\Herd\InspiraUMKM\resources\views/dashboard/options/create.blade.php ENDPATH**/ ?>