...
<?php $__env->startSection('container'); ?>
    ...
    <div class="col-lg-8">
        <form method="post" action="<?php echo e(route('admin.option-values.update', ['option_value' => $optionValue->slug])); ?>"
            class="mb-5">
...
unset($__errorArgs, $__bag); ?>" id="value"
                    name="value" required value="<?php echo e(old('value', $optionValue->value)); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" id="slug" name="slug"
                    required value="<?php echo e(old('slug', $optionValue->slug)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="option_id" required>
                    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($option->id); ?>"
                            <?php echo e(old('option_id', $optionValue->option->id) == $option->id ? 'selected' : ''); ?>>
                ...
                <select class="form-select" name="category_id">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category->id); ?>"
                            <?php echo e(old('category_id', $optionValue->category_id) == $category->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jesse\Herd\InspiraUMKM\resources\views/dashboard/option-values/edit.blade.php ENDPATH**/ ?>