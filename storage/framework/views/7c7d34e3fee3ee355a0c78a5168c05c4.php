<div class="card my-2 d-flex flex-row">
    ...
    <div class="col-4">
        <div class="img-wrapper col-md-4">
            <?php if($design->image): ?>
                <img src="<?php echo e(asset('storage/' . $design->image)); ?>" class="rounded-start" alt="<?php echo e($design->title); ?>">
            <?php else: ?>
                <img src="<?php echo e(asset('img/' . $design->product->name) . '.jpg'); ?>" class="rounded-start" alt="<?php echo e($design->title); ?>">
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="card-body d-flex flex-row justify-content-between h-100">
            ...
            <div class="d-flex justify-content-end align-items-end gap-2">
                ...
                <p class="qty d-flex flex-column justify-content-center m-0" data-design-id="<?php echo e($design->id); ?>"
                    data-design-stock="<?php echo e($design->stock); ?>" data-qty="<?php echo e($design->pivot->quantity); ?>">
                    <?php echo e($design->pivot->quantity); ?>
...
<?php /**PATH C:\Users\jesse\Herd\InspiraUMKM\resources\views/components/cart/cartItem.blade.php ENDPATH**/ ?>