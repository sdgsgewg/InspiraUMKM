...
<?php $__currentLoopData = $checkoutItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sellerId => $sellerGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="seller-section">
        ...
        <div class="d-flex flex-row justify-content-between mt-2">
            <h6><?php echo app('translator')->get('checkout.ordered_amount'); ?> (<?php echo e($productAmount[$idx]); ?>

                <?php echo e($productAmount[$idx] > 1 ? __('checkout.products') : __('checkout.product')); ?>)</h6>
    ...
    ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\Users\jesse\Herd\InspiraUMKM\resources\views/components/checkout/checkout-items.blade.php ENDPATH**/ ?>