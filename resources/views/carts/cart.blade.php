...
@section('container')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 d-flex flex-column">
            ...
            @php
                $cartItems = $carts->sum(fn($cart) => $cart->designs->count());
            @endphp
                        ...
                        <div class="card mb-3 d-flex flex-row">
                            <div class="col-4">
                                <div class="img-wrapper col-md-4">
                                    @if ($design->image)
                                        <img src="{{ asset('storage/' . $design->image) }}" class="rounded-start"
                                            alt="...">
                                    @else
                                        <img src="{{ asset('img/' . $design->category->name) . '.jpg' }}"
